	...
	<div class=NavStepNav style="display:flex;width:100%;justify-content:space-between;">
		...
		<div>
			...
			<ul style="display:flex;position:relative;top:-10px;justfy-content:space-evenly;">
				...
				<li style="margin-left:20px; list-style-type:none;"><button style="width:100px;height:30px;border:2px solid black;border-radius:20px;background-color:royalblue;color:white;" onclick="window.location.href='LostUser'"><%="LogOut".toUpperCase() %></button></li>

	...
	<div class=NavStepNav style="display:flex;width:100%;justify-content:space-between;">
		...
		<div>
			...
			<ul style="display:flex;position:relative;top:-10px;justfy-content:space-evenly;">
				...
				<li style="margin-left:20px; list-style-type:none;"><a style="text-decoration:none;color:white;" href=LogInPage.jsp ><img src='image\user.png' title=logOut alt=ToLogOut height=40px width=40px style="position:relative;top:-10px;" /></a></li>
